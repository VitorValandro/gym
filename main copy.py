...
from telaGUI.modulesTela.principal.TelaInicial import TelaInicial
...
telaHistorico = TelaHistorico(controladorHistorico, telaAluno, telaProfessor, telaTreino)
telaRelatorios = TelaRelatorios(controladorRelatorios, telaAluno, telaProfessor)
...
class TelaPrincipal(Tela):
  ...
  def menu_principal(self):
    ...
    opcao_escolhida = self.inserir_inteiro('Escolha uma tela: ', list(telas.keys()))
